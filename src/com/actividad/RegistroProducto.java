...
public class RegistroProducto {
	...
	// 2. Agregar Producto (Medicamento o Suplemento Alimenticio), sólo si no existe
	// el código.
	...
	// 3. Listar todos los Productos(Medicamento o Suplemento Alimenticio) que
	// tengan un precio base superior a los $10000.
	...
	// 4. Eliminar Producto: Eliminará todos los Productos cuyo precio base es menor
	// a $2.000, indicando cuántos fueron
